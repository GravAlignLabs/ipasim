...
set (LIBFFI_X64_DIR "${BINARY_DIR}/Libffi-x64-Release")
file (MAKE_DIRECTORY "${LIBFFI_X64_DIR}")
execute_process (
    COMMAND "${CMAKE_COMMAND}" -G Ninja
        -DCMAKE_BUILD_TYPE=Release
        "-DCMAKE_C_FLAGS=/FS"
        # The pinned MSVC-era libffi build produces compiler side outputs that
        # sccache cannot reliably archive (notably its debug-info/PDB behavior).
        # Keep the global cache for ipaSim/Unicorn/LIEF, but compile this small
        # dependency directly with cl.exe instead of baking sccache into Ninja.
...
if (NOT LIBFFI_CONFIGURE_RESULT EQUAL 0)
    message (FATAL_ERROR
        "libffi x64 Release configure failed with ${LIBFFI_CONFIGURE_RESULT}")
endif ()
