...
set (LIEF_X64_DIR "${BINARY_DIR}/lief-x64-Debug")
file (MAKE_DIRECTORY "${LIEF_X64_DIR}")
execute_process (
    COMMAND "${CMAKE_COMMAND}" -G Ninja
        ...
        "-DCMAKE_C_FLAGS=-DNOMINMAX -m64 -gcodeview"
        "-DCMAKE_CXX_FLAGS=-DNOMINMAX -m64 -gcodeview"
        "${SOURCE_DIR}/deps/LIEF"
    WORKING_DIRECTORY "${LIEF_X64_DIR}")
