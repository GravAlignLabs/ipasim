...
const DarwinHostCallSignature *findDarwinHostCallSignature(
  ...
  static const DarwinHostCallSignature Signatures[] = {
      ...
      {"__telemetry", 6, true},
      {"__ulock_wait", 4, true},
      {"__ulock_wait2", 5, true},
      {"__ulock_wake", 3, true},
      {"__bzero", 2, false},
      {"_os_alloc_once", 3, true},
      {"_pthread_qos_class_encode", 3, true},
      {"_pthread_qos_class_decode", 3, true},
      {"_pthread_qos_class_and_override_encode", 4, true},
      ...
      {"_pthread_override_qos_class_end_direct", 1, true},
      {"_pthread_workloop_create", 3, true},
      {"_pthread_workloop_destroy", 1, true},
      {"pthread_workqueue_setup", 2, true},
      {"_pthread_workqueue_init_with_workloop", 5, true},
      {"_pthread_workqueue_init_with_kevent", 4, true},
      {"_pthread_workqueue_init", 3, true},
      {"_pthread_workqueue_supported", 0, true},
      {"_pthread_workqueue_addthreads", 2, true},
      {"_pthread_workqueue_should_narrow", 1, true},
      {"_pthread_workqueue_set_event_manager_priority", 1, true},
      {"_pthread_workqueue_override_start_direct", 2, true},
      {"_pthread_workqueue_override_start_direct_check_owner", 3, true},
      {"_pthread_workqueue_override_reset", 0, true},
      {"pthread_key_init_np", 2, true},
      {"pthread_key_create", 2, true},
      {"pthread_key_delete", 1, true},
      ...
      {"host_create_mach_voucher", 4, true},
      {"mach_absolute_time", 0, true},
      {"mach_continuous_time", 0, true},
      {"mach_host_self", 0, true},
      {"mach_timebase_info", 1, true},
      {"mach_msg_overwrite", 9, true},
      {"_platform_bzero", 2, false},
      {"_platform_memccpy", 4, true},
      {"_platform_memchr", 3, true},
      {"_platform_memcmp", 3, true},
      {"_platform_memcmp_zero_aligned8", 2, true},
      {"_platform_memmove", 3, true},
      {"_platform_memset", 3, true},
      {"_platform_memset_pattern4", 3, false},
      {"_platform_memset_pattern8", 3, false},
      {"_platform_memset_pattern16", 3, false},
      {"_platform_strchr", 2, true},
      {"_platform_strcmp", 2, true},
      {"_platform_strcpy", 2, true},
      {"_platform_strlcat", 3, true},
      {"_platform_strlcpy", 3, true},
      {"_platform_strlen", 1, true},
      {"_platform_strncmp", 3, true},
      {"_platform_strncpy", 3, true},
      {"_platform_strnlen", 2, true},
      {"_platform_strstr", 2, true},
      {"os_unfair_lock_lock_with_options", 2, false},
      {"os_unfair_lock_unlock", 1, false},
      {"__interposition_sim_system__platform_memcmp_zero_aligned8", 2, true},
